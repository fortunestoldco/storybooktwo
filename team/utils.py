...
def make_supervisor_node(llm: ChatOpenAI, team_members: List[str], config: Configuration, name: str):
...
def create_team_node(llm: ChatOpenAI, tools: List, system_prompt: str, name: str, config: Configuration):
...
def build_team_graph(supervisor, agents: Dict, config: Configuration, name: str) -> StateGraph:
